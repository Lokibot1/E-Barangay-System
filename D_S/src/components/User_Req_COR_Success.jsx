...
export default function User_Req_COR_Success() {
  const navigate = useNavigate();
  const location = useLocation();
  const formType = location.state?.formType || 'Certificate of Residency';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            <div className="card p-6 mb-6">
              ...
              <p className="text-sm text-gray-600">The Certificate of Residency is an official document that certifies your residency in the barangay. Your application for a Certificate of Residency has been received and is currently under review. If you have any questions or have lost your reference number, please contact our support desk.</p>
            </div>
