...
import ProtectedRoute, { AdminRoute, UserRoute } from "./components/shared/ProtectedRoute";
        ...
        <Routes>
          ...
          <Route element={<AdminRoute />}>
            <Route element={<Layout />}>
              ...
              <Route path="/admin/incidents" element={<AdminPlaceholder title="Incidents" />} />
              <Route path="/admin/appointments" element={<AdminPlaceholder title="Appointments" />} />
              <Route path="/admin/payments" element={<AdminPlaceholder title="Payments" />} />
