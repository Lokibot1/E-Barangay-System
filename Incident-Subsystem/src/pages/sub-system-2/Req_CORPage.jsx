...
const Req_CORPage = () => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      sessionStorage.setItem("req_cor_info_modal_shown", "true");
    }, 700);
          ...
          <div className={`${t.cardBg} ${t.cardBorder} border rounded-2xl p-6 lg:col-span-2`}>
            ...
            <div className="grid grid-cols-1 gap-4 text-left">
              <SelectField
                ...
                t={t}
              />
              <Field label="Years of Residency:" type="number" name="yearsOfResidency" value={formData.yearsOfResidency} onChange={handleFieldChange} t={t} />
            </div>
