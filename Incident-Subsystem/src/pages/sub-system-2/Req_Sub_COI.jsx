        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.9fr_0.8fr] gap-3">
          <div className={`${t.cardBg} ${t.cardBorder} border rounded-2xl p-4`}>
            <div className="flex flex-col items-center text-center">
              ...
              <p className={`font-kumbh text-base ${t.subtleText} mt-2`}>
                Your application for a Certificate of Indigency has been received.
              </p>
            </div>
            ...
            <div className={`font-kumbh text-sm ${t.cardText} space-y-1`}>
              <p><span className="font-bold">Reference Number:</span> COI-2026-1099</p>
              ...
              <p><span className="font-bold">Applicant Name:</span> Alexandra Garcia</p>
            </div>
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center items-center">
              <button
                onClick={() => navigate("/sub-system-2/track-coi")}
                className="bg-green-500 hover:bg-green-600 text-white font-kumbh text-base px-5 py-2 rounded-full min-w-[180px] text-center"
              >
                Track Request Status
              </button>
              <button
                onClick={() => navigate("/sub-system-2")}
                className={`font-kumbh text-base px-5 py-2 rounded-full min-w-[180px] text-center ${t.inputBg} ${t.cardText}`}
              >
                Return to Home
              </button>
            </div>
          ...
          <div className="space-y-4">
            <div className={`${t.cardBg} ${t.cardBorder} border rounded-2xl p-3`}>
              ...
              <p className={`font-kumbh text-sm ${t.cardText} mt-1`}>Valid ID, Personal Appearance (for pick-up).</p>
              <p className={`font-kumbh text-base font-bold ${t.cardText} mt-2`}>Fees:</p>
              <p className={`font-kumbh text-sm ${t.cardText} mt-1`}>₱0.00</p>
              <p className={`font-kumbh text-base font-bold ${t.cardText} mt-2`}>Processing Time:</p>
              <p className={`font-kumbh text-sm ${t.cardText} mt-1`}>1-3 Working Days.</p>
            </div>
