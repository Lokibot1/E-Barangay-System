    ...
    switch (step) {
      case 1:
        ...
        if (!formData.description?.trim()) {
          errs.description = "Please provide a description of the incident";
        }
        break;
      case 2:
        if (!formData.latitude || !formData.longitude) {
          errs.location = "Please pin the incident location on the map";
        }
        break;
      default:
        break;
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      addToast({
        ...
        message:
          "Your incident report has been submitted. We'll review it shortly.",
        duration: 5000,
      });
