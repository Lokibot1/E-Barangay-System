...
import {
  ...
  Pencil, User, Home, FileText, Layers, Landmark, UserCheck,
} from 'lucide-react';
    ...
    <>
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          {/* ── Footer ── */}
          <div className={`pt-2 flex flex-col md:flex-row justify-end items-center gap-4 border-t ${t.cardBorder} ${t.cardBg} mt-2`}>
