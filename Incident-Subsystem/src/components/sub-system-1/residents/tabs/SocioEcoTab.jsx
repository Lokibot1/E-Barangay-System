        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-8">
            ...
            <section className={`${t.cardBg} border ${t.cardBorder} rounded-[2rem] overflow-hidden shadow-sm`}>
                ...
                <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-6">
                    ...
                    <DetailField label="Estimated Monthly Income" name="monthly_income" val={formData.monthly_income} isEdit={isEdit} onChange={handleChange} type="select" options={refs.monthly_income} t={t} />
                </div>
            </section>
            ...
            <section className={`${t.cardBg} border ${t.cardBorder} rounded-[2rem] overflow-hidden shadow-sm`}>
                ...
                <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-6">
                    ...
                    <DetailField label="Institution Type" name="school_type" val={formData.school_type} isEdit={isEdit} onChange={handleChange} type="select" options={refs.school_types} t={t} />
                </div>
            </section>
        </div>
    );
