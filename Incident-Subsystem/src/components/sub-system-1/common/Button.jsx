...
const Button = ({ label, onClick, variant = 'primary', className = '', disabled = false, t }) => {
  ...
  const variants = {
    ...
    outline: `${t ? t.cardBg : 'bg-white'} border border-red-500 text-red-500 hover:bg-red-500 hover:text-white`,
