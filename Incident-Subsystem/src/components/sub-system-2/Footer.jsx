    ...
    <footer className={`${t.cardBg} border-t ${t.cardBorder} py-8 mt-auto`}>
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
          ...
          <div>
            ...
            <p className={`text-sm ${t.subtleText} font-kumbh`}>
              The Document Services System allows residents to conveniently
              request and manage official barangay documents online.
            </p>
          </div>
        ...
        <div className={`pt-6 border-t ${t.dividerBorder} text-center`}>
          <p className={`text-sm ${t.subtleText} font-kumbh`}>
            © {currentYear} Barangay Document Services System. All rights
            reserved.
          </p>
        </div>
      </div>
