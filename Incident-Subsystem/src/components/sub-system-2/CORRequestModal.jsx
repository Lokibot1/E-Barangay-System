  ...
  const validateStep = () => {
    switch (step) {
      ...
      case 2:
        ...
        return true;
      case 3:
        if (!formData.yearsOfResidency) {
          addToast({
            type: "error",
            title: "Missing Required Fields",
            message: "Please provide your years of residency.",
            duration: 4000,
          });
          return false;
        }
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
              <SelectField
                ...
                options={["Employment", "School Enrollment", "Bank Transaction", "Travel / Visa", "Legal Proceedings", "Other"]}
                value={formData.purposeOfRequest}
                onChange={handleFieldChange}
                t={t}
                icon="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"
              />
              <Field label="Years of Residency" type="number" name="yearsOfResidency" value={formData.yearsOfResidency} onChange={handleFieldChange} t={t} placeholder="e.g. 5" required icon="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
            </div>
            ...
            <div>
              ...
              {uploadedFile ? (
                ...
                <div
                  className={`border-2 border-dashed ${t.cardBorder} rounded-xl p-6 text-center cursor-pointer hover:border-indigo-400 transition-colors`}
                ...
                >
                  ...
                  <span className="bg-indigo-500 hover:bg-indigo-600 text-white font-kumbh text-sm px-4 py-2 rounded-lg transition-colors inline-block">
                    Browse Files
                  </span>
          ...
          <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/40 backdrop-blur-sm px-4">
            <div className={`${t.cardBg} ${t.cardBorder} border rounded-2xl w-full max-w-2xl p-6 max-h-[85vh] overflow-y-auto shadow-2xl`}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <PreviewItem label="Years of Residency" value={formData.yearsOfResidency} t={t} />
              </div>
          ...
          <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/40 backdrop-blur-sm px-4">
            <div className={`${t.cardBg} ${t.cardBorder} border rounded-2xl w-full max-w-md p-8 text-center shadow-2xl`}>
              ...
              <p className={`font-kumbh text-sm ${t.subtleText} mt-2`}>
                Your Certificate of Residency request has been submitted successfully. You will be notified once it is ready for pickup.
              </p>
              <button
...
export default CORRequestModal;
